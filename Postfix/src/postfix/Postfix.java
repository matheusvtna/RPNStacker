...
public class Postfix {
	...
	public static void main(String[] args) throws IOException {
		args = new String [3];
		args [0] = "resources/Calc1.stk"; // Only numbers
		args [1] = "resources/Calc2.stk"; // Numbers and IDs
		args [2] = "resources/Calc3.stk"; // Unresolved ID
	...
	private static void run(String source) {
		try {
			...
			interpreter.env.put("y", "4");
			interpreter.env.put("x", "3");		

			System.out.println("Result of expression: " + interpreter.interp(expr));
		} catch (LexError e) {
